    ...
    <main className="flex flex-col items-center justify-center min-h-screen">
      <section className="bg-[#F6F2EF] flex flex-col lg:flex-row items-center justify-around p-0 md:px-12 md:py-14 lg:px-20 lg:py-24 xl:px-32 xl:py-32 w-full">
          <div className="flex flex-col items-center md:items-start justify-center px-7 py-10 md:p-8">
            ...
            <p className="text-body text-gray-600 mb-8 items-start">
              Join open projects, find volunteering network, chat with fellow career changers
            </p>
              <div className="flex flex-col md:flex-row items-center gap-6 mt-4 w-full lg:w-auto">
                <Button asChild className="w-2/3 md:w-auto">
                  <Link href="/register"> Join our community <Image src="/images/button_arrow.svg" alt="Arrow" width={20} height={20} /></Link>
                </Button>
                <Button variant="outline" className="bg-[#F6F2EF] w-2/3 md:w-auto">
                  <Link href="/about">More about Kite</Link>
                </Button>
              </div>
          </div>
          <div className="flex flex-col items-center sm:items-end w-full px-7 py-10 md:p-8">
      ...
      <section className="w-full bg-black flex flex-col items-center text-center justify-between py-12 px-0 md:px-2">
      ...
      <section className="flex flex-row p-4 overflow-x-auto sm:px-0 flex-wrap sm:justify-center">
